...
def main():
    ...
    #VOC_root = "./"  # VOCdevkit
    #VOC_root = r"E:\papercode\deep-learning-for-image-processing-master\pytorch_object_detection\faster_rcnn\VOCtrainval_11-May-2012"
    #VOC_root = r"E:\papercode\deep-learning-for-image-processing-master\pytorch_object_detection\faster_rcnn\VOCtrainval_11-May-2012"
    VOC_root = "E:/papercode/deep-learning-for-image-processing-master/pytorch_object_detection/faster_rcnn/VOCtrainval_11-May-2012"
    #print(VOC_root)
    print(os.path.exists(VOC_root))  # 应返回True
    #一个锚点3个anchor框
